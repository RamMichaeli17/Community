...
public class UserDTO {
    ...
    public String getFullName() { return this.user.getName().getTitle()+" " + this.user.getName().getFirst() +
            " " + this.user.getName().getLast(); }
    ...
    public String getFullLocation() { return this.user.getLocation().getStreet().getName() +
            " " + this.user.getLocation().getStreet().getNumber() +
            ", " +this.user.getLocation().getCity()+", "+this.user.getLocation().getCountry(); }
    ...
    public List<Map<String,String>> getCellPhoneCompanies() {
        ...
        for (CellPhoneCompanyEntity cellPhoneCompanyEntity : this.user.getCellPhoneCompanies()) {
            cellPhonesCompaniesNamesAndID.add(
                    Map.of("companyName", cellPhoneCompanyEntity.getCompanyName(),
                            "cellPhoneCompanyId", cellPhoneCompanyEntity.getCellPhoneCompanyId().toString()));
        }
    ...
    public String getSummary() {return String.format("Hello I'm %s. I'm %d years old and I live in %s. " +
            ...
            "contact me at: %s. By the way, the number of the cell phone companies that related to me is: %d."
            ,this.getFullName(), this.getAge(), this.getFullLocation(), this.getAvatarURL(), this.getEmail(),
            this.getCellPhoneCompanies().size());
    }
}
